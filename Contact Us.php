		...
		<section class="header">
			<div class="container">	
				...
				<div class="header-right pull-right">
					<ul>
						<!-- <li class="reg">
							<a href="Register" data-toggle="modal" data-target=".bs-example-modal-sm">
								Register
							</a>
								/
			...
			<div class="container">
				<div class="contact-details">
					<div class="section-header contact-head  text-center">
						<h2>contact us</h2>
						<p>
							You can contact and join in follwing in this contact box.
						</p>
					</div><!--/.section-header-->
											...
											<div class="contact-office-address">
												...
												<div class="contact-online-address">
													...
													<div class="single-online-address">
														...
														<span>Email: Educare@gmail.com</span>
													</div><!--/.single-online-address-->
						...
						<div class="foot-copyright pull-left">
							<p>
								&copy; All Rights Reserved. Designed and Developed by
							 	<a href="https://www.themesine.com">Project 1</a>
							</p>
						</div><!--/.foot-copyright-->
					</div><!--/.col-->
					<div class="col-sm-5">
